...
**Remaining (mapped, pending).** ~13 orphaned screens: customer booking list/detail/create + confirm/reschedule/cancel; center detail + availability + write-review; business bookings management (accept/reject/status/assign-mechanic) + dashboard + capacity + services/promotions CRUD + team roster CRUD; vehicle detail/edit + maintenance history/add/export; shop reviews; social sign-in (Google/Apple buttons exist, dead). All have a live data layer already.
