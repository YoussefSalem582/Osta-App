...
import 'package:osta/features/shared/shop/presentation/widgets/shop_product_card.dart';
...
class MyProductsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => BlocProvider(
    create: (_) =>
        getIt<MyProductsBloc>()..add(const MyProductsLoadRequested()),
...
class _MyProductsViewState extends State<_MyProductsView> {
  ...
  Future<void> _openForm(BuildContext context, {Product? product}) async {
    ...
    if (saved == true && context.mounted) {
      context.read<MyProductsBloc>().add(const MyProductsLoadRequested());
    }
  }
  ...
  Future<void> _confirmDelete(BuildContext context, Product product) async {
    ...
    context.read<MyProductsBloc>().add(MyProductsDeleteRequested(product.id));
  }
  ...
  Widget _body(BuildContext context, MyProductsState state) {
    ...
    if (state is MyProductsError) {
      return ErrorState(
        ...
        onRetry: () => context.read<MyProductsBloc>().add(
          const MyProductsLoadRequested(),
        ),
      );
    }
