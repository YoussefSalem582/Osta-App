...
import 'package:osta/features/shop/presentation/widgets/category_chips.dart';
...
class _ShopBrowseViewState extends State<_ShopBrowseView> {
  ...
  void _onSearchChanged(String value) {
    ...
    _debounce = Timer(const Duration(milliseconds: 350), () {
      unawaited(context.read<ShopListCubit>().search(value.trim()));
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        BlocSelector<ShopListCubit, ShopListState, String?>(
          ...
          builder: (context, selected) => CategoryChips(
            ...
            onSelected: (c) => context.read<ShopListCubit>().selectCategory(c),
          ),
        ),
        Expanded(
