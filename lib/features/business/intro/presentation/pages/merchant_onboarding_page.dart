...
/// Logged-out merchant marketing carousel. Parallel to the customer
/// `OnboardingPage` — shown after the business role is chosen until the user
/// taps through (`SessionController.acknowledgeOnboarding` + redirect guard).
/// Post-auth center setup stays in `features/business/onboarding/`.
