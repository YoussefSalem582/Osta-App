...
/// Logged-out **customer** marketing carousel. Shown after the customer role
/// is chosen until the user taps through (see
/// [SessionController.acknowledgeOnboarding] + the redirect guard). Merchants
/// use `MerchantOnboardingPage` at `/onboarding/business` instead.
